...
def run(query, constraint):
    ...
    plt.xlabel(r'Hours worked per week', fontsize=85, weight='bold', labelpad=-10).set_position((0.47, -0.1))

    plt.tight_layout()
    plt.legend(loc='upper right', bbox_to_anchor=(1, 0.65), fontsize=65,
