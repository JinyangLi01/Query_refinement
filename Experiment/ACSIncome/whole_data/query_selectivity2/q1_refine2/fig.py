...
def run(query, constraint):
    ...
    plt.xlabel(r'Hours worked per week', fontsize=85, weight='bold', labelpad=-10).set_position((0.46, -0.1))

    plt.tight_layout()
    plt.legend(loc='upper right', bbox_to_anchor=(1, 0.75), fontsize=65,
