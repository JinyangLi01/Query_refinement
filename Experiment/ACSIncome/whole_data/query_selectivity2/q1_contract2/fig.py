...
def run(query, constraint):
    ...
    plt.xlabel(r'Hours worked per week', fontsize=85, weight='bold', labelpad=-10).\
        set_position(((0.48, -0.05)))

    plt.tight_layout()
    plt.legend(loc='upper left', bbox_to_anchor=(0, 0.65), fontsize=65,
