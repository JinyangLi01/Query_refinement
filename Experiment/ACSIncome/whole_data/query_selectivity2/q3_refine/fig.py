...
def run(query, constraint):
    ...
    plt.xlabel(r'Hours worked per week', fontsize=80, weight='bold', labelpad=-10).set_position((0.45, -0.1))

    plt.tight_layout()
    plt.legend(loc='upper left', bbox_to_anchor=(-0.04, 0.7), fontsize=65,
