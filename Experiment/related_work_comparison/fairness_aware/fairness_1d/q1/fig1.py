...
print(execution_time_per, execution_time_first, execution_time_competitior)
...
lgnd = plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.4), fontsize=50, ncol=4, labelspacing=0.2,
                  handletextpad=0.2, markerscale=0.2, columnspacing=0.2, frameon=False)

plt.savefig("comparision_1d_q1.png", bbox_inches='tight')
plt.show()
