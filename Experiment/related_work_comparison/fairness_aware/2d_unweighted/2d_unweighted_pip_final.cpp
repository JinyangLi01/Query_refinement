...
void runSearch(vector<Point> *points, double *minimumPointStartingRange, double *maximumPointStartingRange) {
    ...
    cout << "Initial range, {" << minimumPointStartingRange[0] << ", "<< maximumPointStartingRange[0] << "}, {" << minimumPointStartingRange[1] << ", " << maximumPointStartingRange[1] <<  "}" << endl;
    ...
    cout << "{" << range[0][0] << ", " << range[1][0] << "}, {" << range[0][1] << ", " << range[1][1] << "}" << endl;
    cout << endl;
}
